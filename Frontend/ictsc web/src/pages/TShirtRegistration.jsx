            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" placeholder="e.g. K.M.Nimal Abeysundara" required
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      type="text" placeholder="e.g. TG/20XX/XXXX" required
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      type="tel" placeholder="e.g. 076 123 4568" required
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Select Department</label>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Payment Amount (LKR)</label>
                  <input 
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Upload Receipt Image</label>
                  <input 
